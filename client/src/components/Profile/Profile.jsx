...
export default function Profile({ canUpdate, presence, pfp, userName, bio, genres }) {
                ...
                {isEditing ? (
                    ...
                    <>
                        <div className="profile-view relative h-[90%] mt-5 items-center w-full flex flex-col">
                            <p className="absolute text-4xl top-32 md:top-32 left-0">{userName}</p>
                            <div className="absolute right-0 ">
                                <img src={pfp} className="w-32 relative h-32 rounded-full" alt="profile" />
                                {currentPresence ?
                                    <div title="online" className="relative left-[70%] bottom-5 bg-green-500 h-4 w-4 rounded-full"></div>
                                    : <div title="offline" className="relative left-[70%] bottom-5 top-0 bg-gray-500 h-4 w-4 rounded-full"></div>}
                            </div>

                            {canUpdate ? <p className="absolute text-2xl top-48 md:top-72 left-0">you define yourself as <br /> {bio} </p> : <p className="absolute text-2xl top-48 left-0">merofiru is <br /> {bio}</p>}

...
export default function Layout({ children }) {
    ...
    return (
        <>
            <div onClick={navigateToHome} className="top-left cursor-pointer m-1 absolute top-0 left-0 bg-[#5cc6abeb] w-20 h-20 text-lg md:w-36 md:h-36 transform rotate-90 flex items-center justify-center text-white md:font-bold md:text-2xl rounded-lg shadow-lg">
                merofiru
            </div>
            <div>{children}</div>
